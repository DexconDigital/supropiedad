                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <ul class="pl-0">
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>PRECIO ÚNICO mensual del 10% más IVA de comisión INCLUIDO el Seguro/Fianza de Arrendamiento.</p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                    ...
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>Tomamos fotos con cámara profesional con lentes gran angular.</strong></small></p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>No cobramos al consignar tu inmueble ni pedimos exclusividad.</strong></small></p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>No cobramos costos bancarios.</strong></small></p>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="col-lg-6 col-12">
                                                ...
                                                <ul class="pl-0">
                                                    ...
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>Tomamos fotos con cámara profesional con lentes gran angular.</p>
                                                    </li>
                                                    <li class="d-flex">
                                                        <i class="fas fa-check mt-1 mr-2"></i>
                                                        <p>No cobramos al consignar tu inmueble ni pedimos exclusividad. Solo cobramos al momento de conseguirte el cliente.</p>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
